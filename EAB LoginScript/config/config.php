...
define("DB_PASS", "loginsjLfjelJ01rWO5cc0fjumQru38IOPoov");
...
define("COOKIE_SECRET_KEY", "1gp@TMPS{+$78jhjkgklgfgdfjgdfhgd");
...
define("EMAIL_SMTP_HOST", "ssl://smtp.gmail.com");
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "EmailRemovedForGitHubUpload");
define("EMAIL_SMTP_PASSWORD", "PasswordRemovedForGitHubUpload");
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", "ssl");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://192.168.56.101/php-login-admin/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@brandonabdominalsnowman.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Brandon Bodie");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for Brandon Abominable Snowman");
 ...
 */
define("EMAIL_NEW_ACCOUNT_FROM", "no-reply@brandonabdominalsnowman.com");
define("EMAIL_NEW_ACCOUNT_FROM_NAME", "Brandon Bodie");
define("EMAIL_NEW_ACCOUNT_SUBJECT", "New Account for Brandon Abominable Snowman");
define("EMAIL_NEW_ACCOUNT_BODY", "You have been signed up for a new account at PROJECT ADMIN.  Below is your user name and temporary password, which will expire in 3 days.");

/**
 * Configuration for: account reset email
 * Much the same as registering, but this is for an outdated account
 */
define("EMAIL_RESET_ACCOUNT_FROM", "no-reply@brandonabdominalsnowman.com");
define("EMAIL_RESET_ACCOUNT_FROM_NAME", "Brandon Bodie");
define("EMAIL_RESET_ACCOUNT_SUBJECT", "Your Account with Brandon Abominable Snowman Has Been Reset");
